...
cd /app
export MONGO_OPLOG_URL=mongodb://10.7.7.6/local #TODO: Switch to DNS Names not IPs or set ENV Var
export MONGO_URL=mongodb://10.7.7.6/meteor #TODO: Switch to DNS Names not IPs or set ENV Var
